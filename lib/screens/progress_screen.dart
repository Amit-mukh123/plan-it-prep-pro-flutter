...
class ProgressSummary {
  ...
  final List<_BarData> weeklyCalories;
  ...
  static Future<ProgressSummary> fetchUserProgress() async {
    ...
    return const ProgressSummary(
      ...
      weeklyCalories: [
        ...
        _BarData('T', 62, false),
        _BarData('F', 38, false),
        _BarData('S', 70, false, color: Color(0xFFEDE9FE)),
        _BarData('S', 50, false, color: Color(0xFFEDE9FE)),
      ],
...
class _BarData {
  ...
  const _BarData(this.label, this.height, this.isActive, {this.color});
}
